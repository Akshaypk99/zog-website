...
const View = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      setIsLoading(true)
      API.post("/contact_us/", formData).then((response) => {
  ...
  useEffect(() => {
    if (optionListOpened == true) {
      if (window.innerWidth > 767) {
        $(".option-list").animate({ height: "230px" }, 400)
      }
      else {
        $(".option-list").animate({ height: "165px" }, 400)
      }
  ...
  return (
    <div className='contact-us-page'>
      ...
      <Banner
        ...
        titleMob={"Let's Start<br/> a Conversation.<br/> We Can help!"}
        subTitleWeb={"Reach out to our team for expert IT support and<br/> solutions. To assist you better, please fill out the form."}
        subTitleTab={"Reach out to our team for expert IT support and<br/> solutions. To assist you better, please fill out the<br/> form."}
        subTitleMob={"Reach out to our team for expert<br/> IT support and solutions. To assist<br/> you better, please fill out the form."}>
      </Banner>
      ...
      <div className='sec-2'>
        ...
        <div className='inner'>
          ...
          <div className='segment'>
            ...
            <div className='text'>+44 2045424350</div>
          </div>
        </div>
      </div>
      ...
      <div className='sec-3'>
        <div className='lhs'>
          <h1 className='title'>Connect<br /> with Us</h1>
        </div>
        <div className="rhs">
