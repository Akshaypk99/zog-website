  ...
  return (
    <div className='header' id='header' >
      ...
      <div className='text-menu-box'>
        ...
        <span onClick={()=>{localStorage.setItem("currentPageIndex",7);setCurrentPageIndex(7); navigate("/contact-us")}} className={currentPageIndex===7&&"active"}>CONTACTS</span>
      </div>
      <button className='login-btn' onClick={() => { localStorage.setItem("userRoleRequest", "user"); navigate('/login') }}><img src='/images/header/login-icon.svg'></img></button>
