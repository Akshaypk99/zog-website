  ...
  return (
    <div className='signup auth-container'>
      <AuthBanner
        ...
        paraWeb={"Unlock opportunities by registering an<br/>account and start applying today!"}
        paraTab={"Unlock opportunities by registering an<br/>account and start applying today!"}
        paraMob={"Unlock opportunities by registering<br/>an account and start applying today!"}
        buttonText=""
        buttonOnClick=''
        iconTopWeb={'63%'}
        iconLeftWeb={'53%'}
      ...
      <div className='card'>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <button className='button-black-box' type='submit'>REGISTER</button>
