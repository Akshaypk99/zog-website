  ...
  return (
    <div className='auth-container'>
      <AuthBanner
        ...
        paraWeb={"Don’t have a account? Sign up<br/>now to create an account"}
        paraTab={"Don’t have a account? Sign up now<br/>to create an account"}
        paraMob={"Don’t have a account? Sign up now<br/>to create an account"}
        buttonText="SIGN UP"
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          {(localStorage.getItem("userRoleRequest") === "admin") && isOTPInputShown && (
            <>
              ...
              <button className="brick-btn f-xs w-100">SUBMIT OTP</button>
            </>
          )}
